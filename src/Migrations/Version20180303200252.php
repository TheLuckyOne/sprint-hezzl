...
class Version20180303200252 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE player (id INT NOT NULL, campaign_id INT NOT NULL, login VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(15) NOT NULL, sex BOOLEAN NOT NULL, city VARCHAR(255) NOT NULL, birthday DATE NOT NULL, company VARCHAR(255) NOT NULL, job VARCHAR(255) NOT NULL, score INT NOT NULL DEFAULT 0, coins INT NOT NULL DEFAULT 0, system JSON NOT NULL, last_day TIMESTAMP(0) WITHOUT TIME ZONE, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
